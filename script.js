document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      const errorId = 'error-' + (field.getAttribute('id') || field.getAttribute('name') || Math.random().toString(36).slice(2));
      errorEl.id = errorId;
    ...
    function validateField(field) {
      ...
      if ((fieldType === 'email' || field.getAttribute('type') === 'email') && value.trim() !== '') {
      ...
      if ((fieldType === 'tel' || field.getAttribute('type') === 'tel') && value.trim() !== '') {
  ...
  const OBSERVE_TARGETS = '[class*="fade-in"], [class*="animate"], [class*="reveal"], [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רוני בגדים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '371c9727-0993-4a35-9fc1-cef52e38e021',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '371c9727-0993-4a35-9fc1-cef52e38e021';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '371c9727-0993-4a35-9fc1-cef52e38e021';
